...
{
    if([self.boardDelegate respondsToSelector:@selector(alttextViewEditing:shouldChangeCharactersInRange:replacementString:)])
    {
        return [self.boardDelegate alttextViewEditing:textField shouldChangeCharactersInRange:range replacementString:string];
    }
    return YES;
}
